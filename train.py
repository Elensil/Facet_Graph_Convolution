...
def inferNetOld(in_points, f_normals, f_adj, edge_map, v_e_map,num_wofake_nodes,patch_indices,old_to_new_permutations,num_faces):
    ...
    with tf.Graph().as_default():
        ...
        # fn_rot_n = tf.expand_dims(fn_rot[:,:,:,0],axis=-1)
        # fn_rot_p = tf.expand_dims(fn_rot[:,:,:,1],axis=-1)

        # # fn_rot = tf.matmul(rot_mat,fn_rot)
        # fn_rot_n= tf.matmul(rot_mat,fn_rot_n)

        # fn_rot = tf.concat((fn_rot_n,fn_rot_p),axis=-1)
        ...
        # n_conv_rot = tf.reshape(n_conv, [BATCH_SIZE, -1,3,1])
        # n_conv_rot = tf.matmul(tf.transpose(rot_mat, [0,1,3,2]),n_conv_rot)
        # n_conv_rot = tf.reshape(n_conv_rot, [BATCH_SIZE, -1,3])
        n_conv_rot = n_conv
        squeezed_n_conv_rot = tf.squeeze(n_conv_rot)
        ...
        # return outPoints, predicted_normals, predicted_normalsRaw
...
def update_position_MS_damp(x, face_normals_list, faces, v_faces0, coarsening_steps, iter_num_list=[80,20,20]):
...
def mainFunction():
    ...
    # pickleSrcFolder = "/morpheo-nas2/marmando/DeepMeshRefinement/Synthetic/BinaryDump/FND_el"
    # pickleDestFolder = "/morpheo-nas2/marmando/DeepMeshRefinement/Synthetic/BinaryDump/Dump2_FND_el"
    # repickleFolder(pickleSrcFolder, pickleDestFolder)
    # return

    # # AELFolder = "/morpheo-nas/marmando/DeepMeshRefinement/real_paper_dataset/Synthetic/test/rescaled_gt/"
    # AELFolder = "/morpheo-nas/marmando/DeepMeshRefinement/real_paper_dataset/Kinect_v2/test/noisy/"
    # # AELFolder = "/morpheo-nas/marmando/DeepMeshRefinement/real_paper_dataset/Kinect_Fusion/test/noisy/"
    # avg_edge_len = getFolderAvgEdgeLength(AELFolder, True)
    # print("avg edge length = ",avg_edge_len)
    # return

    # getDepthDirection()
    # checkFND("/morpheo-nas/marmando/DeepMeshRefinement/real_paper_dataset/Synthetic/train/noisy/","leg_n1.obj")
    # return
    ...
    # binDumpPath = "/morpheo-nas2/marmando/DeepMeshRefinement/Kinect_v1/BinaryDump/normals_c4/"
    
    # binDumpPath = "/morpheo-nas2/marmando/DeepMeshRefinement/Kinect_v1/BinaryDump/normals_c8/"
    # binDumpPath = "/morpheo-nas2/marmando/DeepMeshRefinement/Synthetic/BinaryDump/FND_c4/"
    # binDumpPath = "/morpheo-nas2/marmando/DeepMeshRefinement/Synthetic/BinaryDump/Dump2_FND_c4/"
    # binDumpPath = "/morpheo-nas2/marmando/DeepMeshRefinement/Kinect_v2/BinaryDump/normals_c4/"
    # binDumpPath = "/morpheo-nas2/marmando/DeepMeshRefinement/Kinect_Fusion/BinaryDump/normals_c4/"

    # binDumpPath = "/morpheo-nas2/marmando/DeepMeshRefinement/Kinect_v1/BinaryDump/Acc_normals_c4/"
    # binDumpPath = "/morpheo-nas2/marmando/DeepMeshRefinement/Synthetic/BinaryDump/msVertices_c4/"
    # binDumpPath = "/morpheo-nas2/marmando/DeepMeshRefinement/Kinect_v1/BinaryDump/wBorders_c4/"
    # binDumpPath = "/morpheo-nas2/marmando/DeepMeshRefinement/Kinect_v2/BinaryDump/wBorders_c4/"
    # binDumpPath = "/morpheo-nas2/marmando/DeepMeshRefinement/Kinect_v1/BinaryDump/wBorders_c4_4lvl/"
    # binDumpPath = "/morpheo-nas2/marmando/DeepMeshRefinement/Kinect_v2/BinaryDump/wBorders_c4_4lvl/"

    # binDumpPath = "/morpheo-nas2/marmando/DeepMeshRefinement/Kinect_v1/BinaryDump/msVerticeswBA_c4/"
    # binDumpPath = "/morpheo-nas2/marmando/DeepMeshRefinement/Kinect_v1/BinaryDump/msVertices_c4/"
    # binDumpPath = "/morpheo-nas2/marmando/DeepMeshRefinement/Kinect_v1/BinaryDump/wBorders_c4_new2/"
    ...
    def addMeshWGTDispAndNormals(inputFilePath,filename, gtFilePath, gtfilename, in_list, gt_list, adj_list, gt_disp_list, faces_list, mesh_count_list):
        ...
        if facesNum>maxSize:
            ...
            while(np.any(faceCheck==0)):
                ...
                padding6 =np.zeros((new_N-old_N,6))
                # noisyFolder = "/morpheo-nas/marmando/DeepMeshRefinement/real_paper_dataset/Kinect_v1/test/noisy/"
        # gtFolder = "/morpheo-nas/marmando/DeepMeshRefinement/real_paper_dataset/Kinect_v1/test/original/"        padding3 =np.zeros((new_N-old_N,3))
                minusPadding3 = padding3-1
                minusPadding3 = minusPadding3.astype(int)
                patchFNormals = np.concatenate((patchFNormals,padding6),axis=0)
                patchGTFNormals = np.concatenate((patchGTFNormals, padding3),axis=0)
    ...
    if running_mode == 0:
        ...
        # gtnameoffset = 10
        # inputFilePath = "/morpheo-nas2/marmando/DeepMeshRefinement/Kinect_v1/Train_iter/b22_160k/"
        # validFilePath = "/morpheo-nas2/marmando/DeepMeshRefinement/Kinect_v1/Valid_iter/b22_160k/"
        # gtnameoffset = 13
        ...
        if pickleLoad:
            ...
            # binDumpPath2 = "/morpheo-nas2/marmando/DeepMeshRefinement/Kinect_Fusion/BinaryDump/Dump2_wBorders_c4_new/"
            # # binDumpPath2 = "/morpheo-nas2/marmando/DeepMeshRefinement/Synthetic/BinaryDump/Dump2_normals_c4/"
            # # binDumpPath2 = "/morpheo-nas2/marmando/DeepMeshRefinement/Synthetic/BinaryDump/Dump2_FND_c4/"
            # # Training
            # with open(binDumpPath2+'f_normals_list', 'wb') as fp:
            #     pickle.dump(f_normals_list, fp, protocol=2)
            # with open(binDumpPath2+'GTfn_list', 'wb') as fp:
            #     pickle.dump(GTfn_list, fp, protocol=2)
            # with open(binDumpPath2+'f_adj_list', 'wb') as fp:
            #     pickle.dump(f_adj_list, fp, protocol=2)
            # # Validation
            # with open(binDumpPath2+'valid_f_normals_list', 'wb') as fp:
            #     pickle.dump(valid_f_normals_list, fp, protocol=2)
            # with open(binDumpPath2+'valid_GTfn_list', 'wb') as fp:
            #     pickle.dump(valid_GTfn_list, fp, protocol=2)
            # with open(binDumpPath2+'valid_f_adj_list', 'wb') as fp:
            #     pickle.dump(valid_f_adj_list, fp, protocol=2)
            # return
    ...
    # Train network with accuracy loss on point sets (rather than normals angular loss)
        ...
        if pickleLoad:
            ...
            for filename in os.listdir(inputFilePath):
                ...
                #if (filename.endswith(".obj") and not(filename.startswith("buste"))):
                if (filename.endswith(".obj")):
                    if filename.startswith("aaaaaaaaaaaaaaa") or filename.startswith("aaaaaaaaaaaaaaab"):
                        continue
                    print("Adding " + filename + " (" + str(training_meshes_num[0]) + ")")
                    ...
                    # print("WARNING!! Adding each mesh three times! For diversity in the graph coarsening step")
                    # addMeshWithVertices(inputFilePath, filename, gtFilePath, gtfilename, v_pos_list_temp, gtv_pos_list_temp, faces_list_temp, f_normals_list_temp, f_adj_list_temp, v_faces_list_temp, training_meshes_num)
                    # addMeshWithVertices(inputFilePath, filename, gtFilePath, gtfilename, v_pos_list_temp, gtv_pos_list_temp, faces_list_temp, f_normals_list_temp, f_adj_list_temp, v_faces_list_temp, training_meshes_num)

                    addMeshWithVertices(inputFilePath, filename, gtFilePath, gtfilename, v_pos_list_temp, gtv_pos_list_temp, faces_list_temp, f_normals_list_temp, gtf_normals_list_temp, f_adj_list_temp, v_faces_list_temp, training_meshes_num)
                    print("WARNING!! Adding each mesh three times! For diversity in the graph coarsening step")
                    addMeshWithVertices(inputFilePath, filename, gtFilePath, gtfilename, v_pos_list_temp, gtv_pos_list_temp, faces_list_temp, f_normals_list_temp, gtf_normals_list_temp, f_adj_list_temp, v_faces_list_temp, training_meshes_num)
                    addMeshWithVertices(inputFilePath, filename, gtFilePath, gtfilename, v_pos_list_temp, gtv_pos_list_temp, faces_list_temp, f_normals_list_temp, gtf_normals_list_temp, f_adj_list_temp, v_faces_list_temp, training_meshes_num)
            ...
            for filename in os.listdir(validFilePath):
                if (filename.endswith(".obj")):
                    ...
                    addMeshWithVertices(validFilePath, filename, gtFilePath, gtfilename, valid_v_pos_list, valid_gtv_pos_list, valid_faces_list, valid_f_normals_list, valid_gtf_normals_list, valid_f_adj_list, valid_v_faces_list, valid_meshes_num)
    ...
    # Test on faces clustering
        ...
        # f_normals0 = computeFacesNormals(V0, faces0)
        # _, edge_map0, v_e_map0 = getFacesAdj(faces0)
        # f_adj0 = getFacesLargeAdj(faces0,K_faces)
        # fpos0 = getTrianglesBarycenter(V0, faces0)
    ...
    # Test normals transpose
        ...
        for noisyFile in os.listdir(noisyFolder):
            ...
            # f_adj0, _, _ = getFacesAdj(faces0)
            # gt_adj, _, _ = getFacesAdj(faces_gt)
