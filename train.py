...
def run_thingies(f_normals_list, GTfn_list, f_adj_list, images_lists, calibs_lists, valid_f_normals_list, valid_GTfn_list, valid_f_adj_list,valid_images_lists,valid_calibs_lists):
	...
	sess.close()
        ...
        csv_filename = RESULTS_PATH+"/archi15_patches.csv"
	...
	if running_mode == 0:
		...
		# Get GT mesh
			...
			v_e_map = np.expand_dims(v_e_map, axis=0)
                        ...
                        print("running ...")
                        upV, upN0 = run_thingy(V0, faces_noisy_modif, f_normals0, f_adj_noisy, edge_map_noisy, v_e_map_noisy,[loaded_images],[loaded_calibs])
